...
if [ "$LOCAL_JMX" = "yes" ]; then
  ...
  #CUSTOM OPTIONS
  JVM_OPTS="$JVM_OPTS -Djava.rmi.server.hostname=cassandra-lab"
  JVM_OPTS="$JVM_OPTS -Dcom.sun.management.jmxremote=true"
  JVM_OPTS="$JVM_OPTS -Dcassandra.jmx.remote.port=$JMX_PORT"
  #JVM_OPTS="$JVM_OPTS -Dcom.sun.management.jmxremote.port=$JMX_PORT" #Deprecated
...
JVM_OPTS="$JVM_OPTS $JVM_EXTRA_OPTS" #Default

# Local scrape agent
#JVM_OPTS="$JVM_OPTS -javaagent:/jmx_prometheus_javaagent.jar=7070:/jmx_exporter.yaml $JVM_EXTRA_OPTS"

# Remote scrapte agent
#JVM_OPTS="$JVM_OPTS -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=7199 -Dcom.sun.management.jmxremote.local.only=false -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false $JVM_EXTRA_OPTS"